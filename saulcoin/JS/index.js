...
document.getElementById("autominers2").onclick = function() {
  if (score >= automineUpgrade2) {
    ...
    automine2 = automine2 + 2;
    autoCount2 = autoCount2 + 1;
    document.getElementById("autominers2").innerHTML = ("better autoiner (2x speed & earnings) (-" + automineUpgrade2 + " saulcoins) - - - you have " + autoCount2 + " better autominer(s)");
  } else {
    alert("ur literally 2 poor lmao");
  }
}
